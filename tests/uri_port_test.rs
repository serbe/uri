...
//     let expect_url = "http://www.example.com:as%20df/";
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com:-2/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com:8080/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com:%E1%8D%A9/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com:%F0%9D%9F%96/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
