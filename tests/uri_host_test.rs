...
//     let expect_uri = "http://google.com/";
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://goo%20%20goo%7C%7C.com/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://goo%20%20goo.com/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let input = r#"http://GOO\u200b\u2060\ufeffgoo.com/"#;
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://googoo.com/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://www.foo.bar.com/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://%EF%BF%BDzyx.com/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
// //     let uri: Uri = Uri::try_from(input).unwrap();
// //     let expect_uri = "http://xn--6qqa088eba/";
// //     assert_eq!(&uri.normalize(), expect_uri);
// // }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://%253gxc0.0250..01/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://192.168.0.1%20hello/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://192.168.0.257/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://go@ogle.com/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://lookout.net/";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_uri = "http://google.com/foo";
//     assert_eq!(&uri.normalize(), expect_uri);
// }
