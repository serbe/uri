...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[::ffff:c0a8:1.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[0:1:2:3:4:5:6:7.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[a:b:c:de:ff:0:1:ac.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[1::2:0:0:3:0.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[::ffff:c001:2.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let input = "http://[2001:db8::1.]/";
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[2001:db8::1.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://[1:2:3:4:5:6:0:8.]/";
//     assert_eq!(&uri.normalize(), expect_url);
// }
