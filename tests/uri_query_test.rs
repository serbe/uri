...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?as?df";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?%02hello%7F%20bye";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?%40%41123";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?q=%26%2320320%3B%26%2322909%3B";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?q=%26%2355296%3B%26%2355296%3B";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?q=%3Casdf%3E";
//     assert_eq!(&uri.normalize(), expect_url);
// }
...
//     let input = "http://www.example.com/?q=\"asdf\"";
//     let uri: Uri = Uri::try_from(input).unwrap();
//     let expect_url = "http://www.example.com/?q=%22asdf%22";
//     assert_eq!(&uri.normalize(), expect_url);
// }
